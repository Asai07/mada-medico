...
const Hero = () => {
    return (
        <section className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden bg-[#fdfdfd] font-sans">
            {/* --- Background Elements --- */}
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute -top-[20%] -right-[10%] w-[600px] h-[600px] bg-[#95b2ed]/10 rounded-full blur-3xl"></div>
                <div className="absolute top-[40%] -left-[10%] w-[400px] h-[400px] bg-[#bcb5ff]/10 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
                ...
                <div className="lg:col-span-7 flex flex-col justify-center">
                    ...
                    >
                        {/* --- HEADLINE --- */}
                        {/* Ajustado a text-[4.6rem] en pantallas grandes como solicitaste */}
                        <h1 className="text-4xl sm:text-5xl lg:text-[4.6rem] leading-[1.1] tracking-tight text-[#374e86] font-bold mb-8">
                            Cuando tu consulta <br className="hidden md:block" />
                            <span className="flex flex-wrap items-baseline gap-x-3">
                                <span>ya</span>
                                <span className="font-serif italic font-bold text-[#4a63a3]">
                                    vende,
                                </span>
                            </span>
                            pero tu agenda se sostiene de la
                            <span className="relative inline-block ml-3">
                                ...
                                <motion.span
                                    ...
                                    className="absolute bottom-2 left-0 h-[0.3em] bg-[#e7f1ad]/80 -z-0 transform -rotate-1 mix-blend-multiply"
                                />
                            </span>
                        </h1>

                        {/* --- PÁRRAFO DESTACADO --- */}
                        {/* Aumenté la opacidad (text-[#374e86] en vez de /70) y el tamaño un poco para destacarlo */}
                        <motion.p
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 0.6, duration: 0.8 }}
                            className="text-lg md:text-xl text-[#374e86] max-w-lg leading-relaxed mb-10 font-medium pl-4 border-l-4 border-[#e7f1ad]"
                        >
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 text-[#374e86]/80">
                                <span className="text-2xl">⏱️</span>
                                <p className="text-sm font-semibold max-w-[150px] leading-tight">
                ...
                <div className="lg:col-span-5 relative flex items-center justify-center mt-12 lg:mt-0 pointer-events-none">
                    <div className="relative w-[320px] h-[320px] lg:w-[450px] lg:h-[450px] flex items-center justify-center">
                        ...
                        <motion.div
                            ...
                            className="absolute inset-0 bg-gradient-to-br from-[#f0f4ff] to-[#e6eeff] border border-white shadow-2xl shadow-[#95b2ed]/30 opacity-80"
                        />
